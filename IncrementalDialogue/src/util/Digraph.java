...
public class Digraph<V> {
    ...
    public Map<V,List<V>> getNeighbours(){
    ...
    public List<V> getDaughters(V vertex){
    ...
    public List<V> getParents(V vertex){
    	...
    	for (V v: neighbors.keySet()){
    		if (this.getDaughters(v).contains(vertex)&!parents.contains(v)){
    			parents.add(v);
    		}
    	}
    	return parents;
    ...
    public static void main (String[] args) {
        ...
        graph.add("red", "red and apple"); graph.add("apple", "red and apple");
        graph.add("big", "big for apple");
        graph.add("big for apple", "big and red and apple");
        graph.add("red and apple", "big and red and apple");
        graph.add("big and red and apple", "the(r)");
        ...
        System.out.println(graph.getParents("big and red and apple"));
