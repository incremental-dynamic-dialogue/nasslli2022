...
public class RobotIntentionFrameIU extends IU {
	 ...
	 */
	public RobotIntentionFrameIU(String id, String action, double conf) {
		setObjectID(id);
		setAction(action);
		setRelation(null);
	 ...
	 */
	public RobotIntentionFrameIU(String id, String action, ArrayList<String> targetpos, double conf) {
		setObjectID(id);
		setAction(action);
	 ...
	 */
	public RobotIntentionFrameIU(String id, String action, GoalLocationRelation relation, ArrayList<String> targetpos, double conf) {
		setObjectID(id);
		setAction(action);
